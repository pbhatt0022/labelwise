    ...
    <div className="min-h-screen bg-background pb-[80px]">
      ...
      <div className="px-[24px] mt-[24px] space-y-[16px]">
        ...
        <div className="bg-card rounded-xl p-[16px] shadow-card">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            This tool is an educational aid for label literacy. It is not medical advice and it may miss ingredients if the
            entered text is incomplete.
          </p>
        </div>
      </div>
